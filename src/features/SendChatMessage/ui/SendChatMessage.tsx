...
const GREEN = "var(--accentColor)";
const LIGHTGRAY = "var(--uiKitBorderColor)";
const LIME = "var(--secondaryAccentColor)";
const GRAY = "var(--secondaryTextColor)";
    ...
    <div className={styles.container}>
      ...
      >
        <input
          ...
          onKeyDown={(e) =>
            e.key === "Enter" && focused.current && sendMessage()
          }
